 ...
 */
session_start();
if(!is_dir($_SERVER["DOCUMENT_ROOT"].'/uploaded/'.$_SESSION["lot"])) mkdir($_SERVER["DOCUMENT_ROOT"].'/uploaded/'.$_SESSION["lot"],0755);
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => $_SERVER["DOCUMENT_ROOT"].'/uploaded/'.$_SESSION["lot"].'/',
            'upload_url' => $_SERVER["SCRIPT_URL"].'/uploaded/'.$_SESSION["lot"].'/',
