...
// import { libraryList, AjoutLibrary } from '../accueil/File';
...
export default function Donation() {
    ...
    const initialOptions = {
        "client-id": "AeUH1A_fY7Upu8xtSHVralnCJOTQDK5LwvAE3hO6Gvsh7WojtD2rIQDQnov06dTmT8w9jejsZ7My2zOk",
        currency: "EUR"
    };
                                ...
                                <img src="assets/img/partenaires/f5.jpeg" class="img-fluid" alt=""/> */}
                                    ...
                                    <div class="col-lg-6">
                                        <form class="donation-form">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control" name="type_donateur" id="type_donateur" placeholder='Statut'>
                                        ...
                                        {/* <script src="https://www.paypal.com/sdk/js?client-id=ATCKJ2Zw3emVr6t5D1-U50_SHPPq8SF-rGksS227l-giDwHAAdCdqce-4Coprt2iLU7d7G6k0tmNuMK2&currency=EUR"></script> */}
